...
(function() {
    angular
        .module("NewsApp")
        .controller("ManageCommentsController", ManageCommentsController);

    function ManageCommentsController($routeParams, $location, NewsSourcesService)
    {
        console.log("inside ManageCommentsController controller");
        var vm = this;
